...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({ product, onClose }) => {
  ...
  const handleInquirySubmit = (e: React.FormEvent) => {
    ...
    if (inquiryName && inquiryPhone) {
      ...
      const waUrl = `https://wa.me/919307990811?text=${encodeURIComponent(messageText)}`;
        ...
        <div className="overflow-y-auto p-6 md:p-8 space-y-8">
          ...
          <div className="bg-gradient-to-r from-animex-blue-900 via-slate-900 to-animex-blue-950 p-6 rounded-3xl text-white space-y-4">
            <div className="flex items-center justify-between">
              ...
              <a
                href={`https://wa.me/919307990811?text=Hello%20ANIMEX,%20I%20want%20quote%20for%20${encodeURIComponent(product.title)}%20(${encodeURIComponent(currentPack)})`}
                target="_blank"
                rel="noreferrer"
