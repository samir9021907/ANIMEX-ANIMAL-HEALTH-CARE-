                ...
                >
                  ...
                  <div className="p-5 pt-0 space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-1 border-t border-slate-100 dark:border-slate-800">
                      ...
                      <a
                        href={`https://wa.me/919825012345?text=Hello%20ANIMEX,%20I%20want%20price%20quote%20for%20${encodeURIComponent(product.title)}`}
                        target="_blank"
                        rel="noreferrer"
              ...
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 w-full md:w-auto shrink-0 pt-3 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-slate-800 justify-end">
                    ...
                    <a
                      href={`https://wa.me/919825012345?text=Hello%20ANIMEX,%20I%20want%20quote%20for%20${encodeURIComponent(product.title)}`}
                      target="_blank"
                      rel="noreferrer"
